...
<li><a href="${pageContext.request.contextPath}/AdminSuperMen"><span class="fa fa-caret-right"></span>高级用户</a></li>
    ...
    <div class="content">
        <div class="header">
            <h1 class="page-title">客房类型</h1>
                    <ul class="breadcrumb">
        </ul>
        </div>
        <div class="main-content">
<div class="btn-toolbar list-toolbar">
    <li class="btn btn-primary"><a class="adminadd" href="${pageContext.request.contextPath}/adminAddRoomType.jsp">添加客房类型</a></li>
    <li style="font-size:14px;color:red;list-style:none;">${Msg }</li>
  <div class="btn-group">
  </div>
</div>
<table class="table">
...
<c:forEach items="${requestScope.items }" var="item" varStatus="vs">
	  <tr>
	    ...
	    <td >${item.price }</td>
	    <td>
          <a href="AdminRoomType?id=${item.id }"><i class="fa fa-pencil"></i></a>
          <a href="DeleteRoomType?id=${item.id }" role="button" data-toggle="modal"><i class="fa fa-trash-o"></i></a>
        </td>
	  </tr>
</c:forEach>
</tbody>
