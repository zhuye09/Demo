...
<form id="tab" method="post" action="${pageContext.request.contextPath }/AdminEditRoomType" onsubmit="return checkdata()">
<div class="row">
  <div class="col-md-4">
    <br>
    <div id="myTabContent" class="tab-content">
      ...
      <c:forEach items="${requestScope.items }" var="item" varStatus="vs">
        ...
        <label>房间类型</label>
        <input type="text" name="typeName" value="${item.typeName}" class="form-control">
        <input type="hidden" name="id" value="${item.id }">
        </div>
        <div class="form-group">
        <label>房间面积</label>
        <input type="text" name="areas" value="${item.areas}" class="form-control" onblur="checkAreas()">
        <span id="pro_areas" style="color:red;font-size:14px;"></span>
        </div>
        <div class="form-group">
        <label>房间床位</label>
        <input type="text" name="beds" value="${item.beds}" class="form-control" onblur="checkBeds()">
        <span id="pro_beds" style="color:red;font-size:14px;"></span>
        </div>
        <div class="form-group">
        <label>房间价格</label>
        <input type="text" name="price" value="${item.price}" class="form-control" onblur="checkPrice()">
