...
<table class="table">
  ...
  <c:forEach items="${requestScope.items }" var="item" varStatus="vs">
    <tr>
      ...
      <c:if test="${item.headerimage == 'userdefault.gif'}">
                <img class="user"src="${pageContext.request.contextPath }/headerimages/${item.headerimage }">
                </c:if>
                <c:if test="${item.headerimage !='userdefault.gif'}">
                <img class="user"  src="${pageContext.request.contextPath }/headerimages/${item.headerimage }_48.jpg">
                </c:if>
      </td>
      <td>${item.userName }<br><span class="text-sm"> <a href="#editUser" data-toggle="modal" class="padding-right-small"><i class="fa fa-pencil "></i> Edit</a> <a href="#myModal" data-toggle="modal"><i class="fa fa-trash-o "></i> Delete</a></span></td>
      <td>${item.roleName }<br></td>
      <td style="font-size: 1.25em; padding-top: 1em;" class="hidden-xs text-muted"><a href="#"><i class="fa fa-facebook "></i></a> <a href="#"><i class="fa fa-twitter "></i></a> <i class="fa fa-github "></i>  <a href="#"><i class="fa fa-google "></i></a> <a href="#"><i class="fa fa-linkedin "></i></a></td>
      <td><i class="fa fa-bell text-danger"></i>${item.tel }</td>
    </tr>
  </c:forEach>
  </tbody>
</table>
