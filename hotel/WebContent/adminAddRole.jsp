...
function check_Msg(){
	...
	var rol_propet=document.getElementById("rol_propet");
	/* var company=document.getElementById("company").value;
	var rol_com=document.getElementById("rol_company"); */
	if (roleName=="") {
		rol_propet.innerHTML="角色名不能为空";
		return false;
	}
	/* if(company==""){
		rol_company.innerHTML="公司名称不能为空";
		return false;
	} */
	rol_propet.innerHTML="<p style='font-size:14px; color:red;'>正确</p>";
	rol_company.innerHTML="<p style='font-size:14px; color:red;'>正确</p>";
	return true;
}
...
<li><a href="${pageContext.request.contextPath}/AdminSuperMen"><span class="fa fa-caret-right"></span>高级用户</a></li>
    ...
    <div class="content">
        <div class="header">
            ...
            <li><a href="adminAddRole.jsp">添加职务</a> </li>
        </ul>
        </div>
...
<div class="row">
  <div class="col-md-4">
    ...
    <div id="myTabContent" class="tab-content" style="width:316%;">
      ...
      <form class="form-horizontal" role="form" method="post" onsubmit="return check_submit()" action="${pageContext.request.contextPath}/AdminAddRole">
  <div class="form-group" style="margin-left:2em;">
    <label for="lastname"  class="col-sm-2 control-label" style="width:10em;">职务名:</label>
    <div class="col-sm-10" style="width:20em;">
      <input type="text" class="form-control" name="roleName" id="roleName" onblur="check_Msg()" placeholder="请输入角色名"><br>
      <span id="rol_propet" style="font-size:14px; color:red;"></span>
    </div>
  </div>
  <div class="form-group"  style="margin-left:2em;">
    <label for="firstname" class="col-sm-2 control-label" style="width:10em;">职务描述:</label><br>
    
    <div class="col-sm-10" style="width:20em;">
      <textarea value="Smith" rows="3" class="form-control" id="roleDesc" name="roleDesc" placeholder="请输入角色描述"></textarea><br>
    ...
    <div class="form-group" style="margin-left:2em;">
    <label for="firstname" class="col-sm-2 control-label" style="width:10em;">公司名称:</label>
    <div class="col-sm-10" style="width:20em;">
    	<input type="text" class="form-control" name="company" id="company" placeholder="输入公司名称"><br>
    	<span id="rol_company" style="font-size:14px; color:red;"></span>
    	
    </div>
  </div>
  <div class="form-group" style="margin-left:2em;">
    <div class="col-sm-offset-2 col-sm-10" style="width:6em;margin-left:13em;">
      <input type="submit" style="align:center;" class="btn btn-default" value="添加">
    </div>
  </div>
</form>
      </div>
