...
<ul class="nav nav-tabs">
 ...
 <form id="tab" method="post" action="${pageContext.request.contextPath}/AdminEditRole">
<div class="row">
  <div class="col-md-4">
    <div id="myTabContent" class="tab-content">
      ...
      <c:forEach items="${requestScope.items}" var="item" varStatus="vs">
        ...
        <input type="hidden" value="${item.dropState }" name="dropState">
        <input type="text" value="${item.roleName}" name="roleName" class="form-control">
        </div>
        <div class="form-group">
        <label>角色描述</label>
        <input type="text" value="${item.roleDesc}" name="roleDesc"  class="form-control">
        </div>
        </c:forEach>
      </div>
    </div>
