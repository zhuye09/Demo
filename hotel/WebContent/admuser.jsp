...
<form id="tab" method="post" action="${pageContext.request.contextPath }/admuserServlet">
<div class="row">
  <div class="col-md-4">
    <br>
    <div id="myTabContent" class="tab-content">
      <div class="tab-pane active in" id="home">
        ...
        <div class="form-group">
        <label>真实姓名</label>
        <input type="text" name="trueName" value="${sessionScope.user.trueName}" readonly="readonly" class="form-control">
        </div>
        <div class="form-group">
        <label>电话</label>
        <input type="text" name="tel" value="${sessionScope.user.tel}" readonly="readonly" class="form-control">
        </div>
      </div>
