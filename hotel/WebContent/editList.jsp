...
<body class=" theme-blue">
    <script type="text/javascript">
        ...
        function reginMoney(){
        	var incost= 0;
        	var s = document.getElementById("regDays").value;
        	incost=s*parseFloat(document.getElementById("zhehoujia").value)-(parseFloat(document.getElementById("lastFee").value));
        	
    	    document.getElementById("incost").value = incost;
        }
    </script>
    <style type="text/css">
        #line-chart {
...
<form class="form-horizontal" action="${pageContext.request.contextPath}/EditList?id=${items.orderlist_id}" method="post" role="form">
<ul>
...
<div class="guke">
	...
	<div class="guke4"><input type="text" readonly="readonly" id="roomid" name="idCard" class="form-control" id="roomid" value="${items.roomid }"></div>
	<div class="guke3">原价:</div>
	<div class="guke4"><input readonly="readonly" id="price" type="text" name="price" class="form-control" value="${items.price }"></div>
	<div class="guke3">顾客类型:</div>
	<div class="guke4"><input id="idType" readonly="readonly" type="text" name="idType" class="form-control" value="${items.idType }" ></div>
	<div class="guke3">折后价:</div>
	<div class="guke4"><input id="zhehoujia" type="text" name="zhehoujia" class="form-control" value="${zhehoujia }"></div>
</div>
<div class="xian2"></div>
...
<div class="guke">
	...
	<div class="guke3">剩余金额:</div>
	<div class="guke4"><input type="text" name="lastFee" class="form-control" id="lastFee" value="${lastFee }"></div>
	<div class="guke3">续住天数:</div>
	<div class="guke4"><input id="regDays" type="text" name="regDays" class="form-control" ></div>
	<div class="guke3">应交金额:</div>
	<div class="guke4"><input type="text" name="inCost" class="form-control" id="incost" value=""></div>
	<div class="guke3"></div>
	<div class="guke4"><input type="button" name="button2" id="button2" onclick="reginMoney();" class="btn btn-default" value="生成续住单"></div>
</div>
<div class="xian2"></div>
<div class="guke1"></div>
	<div class="guke2"><input type="button"  name="button" class="btn btn-default" id="button" value="打印订单"></div>
	<div class="guke1"></div>
	<div class="guke2"><input type="submit" name="button2" id="button2" class="btn btn-default" value="续住"> </div>
