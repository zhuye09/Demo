...
<body class=" theme-blue">
    ...
    <ul>
    <li><a href="#" data-target=".dashboard-menu" class="nav-header" data-toggle="collapse"><i class="fa fa-fw fa-dashboard"></i>信息管理<i class="fa fa-collapse"></i></a></li>
    <li><ul class="dashboard-menu nav nav-list collapse in">
            <li><a href="index.jsp"><span class="fa fa-caret-right"></span>基本信息</a></li>
            <li ><a href="users.jsp"><span class="fa fa-caret-right"></span> 用户列表</a></li>
            <li ><a href="user.jsp"><span class="fa fa-caret-right"></span>
            用户资料</a></li>
    </ul></li>
    <li data-popover="true" rel="popover" data-placement="right"><a href="#" data-target=".premium-menu" class="nav-header collapsed" data-toggle="collapse"><i class="fa fa-fw fa-fighter-jet"></i>高级功能<i class="fa fa-collapse"></i></a></li>
        <li><ul class="premium-menu nav nav-list collapse">
                <li class="visible-xs visible-sm"><a href="#">- Premium features require a license -</a></span>
            <li ><a href="premium-pricing-tables.jsp"><span class="fa fa-caret-right"></span>套餐表</a></li>
            <li ><a href="premium-upgrade-account.jsp"><span class="fa fa-caret-right"></span>升级账户</a></li>
            <li ><a href="premium-timeline.jsp"><span class="fa fa-caret-right"></span>活动时间表</a></li>
            <li ><a href="premium-invoice.jsp"><span class="fa fa-caret-right"></span>订单管理</a></li>
            <li ><a href="premium-colors.jsp"><span class="fa fa-caret-right"></span>客房状态</a></li>
    </ul></li>
