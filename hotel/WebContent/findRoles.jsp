...
<li><a href="${pageContext.request.contextPath}/AdminSuperMen"><span class="fa fa-caret-right"></span>高级用户</a></li>
    ...
    <div class="content">
        <div class="header">
            <h1 class="page-title">查询职务</h1>
                    <ul class="breadcrumb">
            <li><a href="adminIndex.jsp">首页</a> </li>
            <li class="FindRoleServlet">查询职务</li>
        </ul>
        </div>
        <div class="main-content">
<div class="btn-toolbar list-toolbar">
	<ul>
    <li class="btn btn-primary" ><a class="adminadd" href="FindRoleServlet">角色列表</a></li>
    </ul> 
  <div class="btn-group"></div>
</div>
<div style="text-align:center;"><span style="color:red;">${Msg}</span></div>
<table class="table">
  <thead>
    <tr>
      <th>编号</th>
	   ...
	   <c:if test="${item.dropState == 1}">
		  	<tbody>
			    <tr>
			      ...
			      <td>${item.company }</td>
			      <td>
			          <a href="${pageContext.request.contextPath }/AdminFindByRoleId?id=${item.id}"><i class="fa fa-pencil"></i></a>
			      </td>
			      <td>
			          <a href="DelRoleServlet?id=${item.id }"  data-toggle="modal"><i class="fa fa-trash-o"></i></a>
			      </td>
			    </tr>
		    </tbody>
	    </c:if>
