...
<div class="row">
    <div class="col-md-12 main-content">
        ...
        <h1 class="page">价目表</h1>
        <div class="row pricing">
            <div class="col-sm-3">
                <div class="product">
                    <h2 class="text-info">单间</h2>
                    <ul>
                        <li class="price large">￥88.8 / 天</li>
                        <li>偏东北方位</li>
                        <li>88m<sup>2</sup></li>
                        <li>0.8折扣</li>
                    </ul>          
            ...
            <div class="col-sm-3">
                <div class="product">
                    <h2 class="text-info">标间</h2>
                    <ul>
                        <li class="price large">￥188.8 / 天</li>
                        <li>偏东北方位</li>
                        <li>108m<sup>2</sup></li>
                        <li>0.8折扣</li>
                    </ul>          
                </div>
            </div>
            <div class="col-sm-3">
                <div class="product">
                    <h2 class="text-info">豪华间</h2>
                    <ul>
                        <li class="price large">￥288.8 / 天</li>
                        <li>偏西南方位</li>
                        <li>128m<sup>2</sup></li>
                        <li>0.8折扣</li>
                    </ul>          
                </div>
            </div>
            <div class="col-sm-3">
                <div class="product">
                    <h2 class="text-info">至尊间</h2>
                    <ul>
                        <li class="price large">￥888.8 / 天</li>
                        <li>偏正南方位</li>
