...
<body class=" theme-blue">
    ...
    <li><ul class="dashboard-menu nav nav-list collapse in">
            ...
            <li ><a href="LeaderIncome.jsp"><span class="fa fa-caret-right"></span>收益量</a></li>
            <li ><a href="Leadertimeline.jsp"><span class="fa fa-caret-right"></span>活动时间表</a></li>
    </ul></li>
...
<form id="tab" method="post" action="${pageContext.request.contextPath }/LeaderuserServlet">
<div class="row">
  <div class="col-md-4">
    <br>
    <div id="myTabContent" class="tab-content">
      <div class="tab-pane active in" id="home">
       ...
       <c:if test="${sessionScope.user.gender.equals('女')}">
        ...
        <div class="form-group">
        <label>真实姓名</label>
        <input type="text" name="trueName" value="${sessionScope.user.trueName}" class="form-control">
        </div>
        <div class="form-group">
        <label>电话</label>
        <input type="text" name="tel" value="${sessionScope.user.tel}" class="form-control">
        </div>
      </div>
    </div>
